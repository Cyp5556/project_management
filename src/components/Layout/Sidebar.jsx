...
import { Layout, FileText, ChevronRight, ChevronDown } from 'lucide-react';
...
const Sidebar = () => {
  ...
  return (
    <div className={`w-64 ${isDark ? 'bg-gray-800' : 'bg-gray-100'} border-r ${isDark ? 'border-gray-700' : 'border-gray-200'} p-4 overflow-auto`}>
        ...
        {projects.map(project => (
          <div key={project.id}>
            ...
            >
              ...
              {expandedProjects.includes(project.id) ? <ChevronDown size={16} /> : <ChevronRight size={16} />}
            </div>
            ...
            {expandedProjects.includes(project.id) && (
              <div className="ml-4 mt-2 space-y-1">
                ...
                <div className="text-xs font-semibold text-gray-500 uppercase mb-1 mt-3">Boards</div>
